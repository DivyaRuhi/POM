...
```
Error: locator.click: Error: strict mode violation: getByRole('link') resolved to 46 elements:
    1) <a class="skipToContent_fXgn" href="#__docusaurus_skipToContent_fallback">Skip to main content</a> aka getByRole('link', { name: 'Skip to main content' })
    2) <a href="/" class="navbar__brand">…</a> aka getByRole('link', { name: 'Playwright logo Playwright' })
    3) <a href="/docs/intro" class="navbar__item navbar__link">Docs</a> aka getByRole('link', { name: 'Docs' })
    4) <a class="navbar__item navbar__link" href="/docs/api/class-playwright">API</a> aka getByRole('link', { name: 'API' })
    5) <a href="/community/welcome" class="navbar__item navbar__link">Community</a> aka getByRole('link', { name: 'Community' })
    6) <a target="_blank" rel="noopener noreferrer" aria-label="GitHub repository" href="https://github.com/microsoft/playwright" class="navbar__item navbar__link header-github-link"></a> aka getByRole('link', { name: 'GitHub repository' })
    7) <a target="_blank" rel="noopener noreferrer" aria-label="Discord server" href="https://aka.ms/playwright/discord" class="navbar__item navbar__link header-discord-link"></a> aka getByRole('link', { name: 'Discord server' })
    8) <a href="https://playwright.dev/docs/intro">TypeScript</a> aka getByRole('link', { name: 'TypeScript' })
    9) <a href="https://playwright.dev/python/docs/intro">Python</a> aka getByRole('banner').getByRole('link', { name: 'Python' })
    10) <a href="https://playwright.dev/dotnet/docs/intro">.NET</a> aka getByRole('banner').getByRole('link', { name: '.NET' })
    ...
...
> 15 |   await page.getByRole('link').click();
     |                                ^ Error: locator.click: Error: strict mode violation: getByRole('link') resolved to 46 elements:
  16 | 
